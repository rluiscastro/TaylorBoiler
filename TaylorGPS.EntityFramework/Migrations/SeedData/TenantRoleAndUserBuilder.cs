...
namespace TaylorGPS.Migrations.SeedData
{
    public class TenantRoleAndUserBuilder
    {
        private readonly TaylorGPSDbContext _context;
        private readonly int _tenantId;

        public TenantRoleAndUserBuilder(TaylorGPSDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            if (adminRole == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new TaylorGPSAuthorizationProvider())
