...
using TaylorGPS.Sessions;
using TaylorGPS.Web.Controllers.Results;
using TaylorGPS.Web.Models;
using TaylorGPS.Web.Models.Account;
...
{
    public class AccountController : TaylorGPSControllerBase
    {
